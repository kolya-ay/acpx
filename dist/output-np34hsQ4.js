import { $ as getPerfMetricsSnapshot, B as absolutePath, Bt as toAcpErrorPayload, C as mergeSessionOptions, D as applyLifecycleSnapshotToRecord, Dt as TimeoutError, E as applyConversation, Et as InterruptedError, F as modelStateFromConfigOptions, Ft as formatErrorMessage, G as listSessions, Gt as OUTPUT_ERROR_ORIGINS, H as findSession, I as splitCommandLine, It as isRetryablePromptError, J as pruneSessions, K as listSessionsForAgent, Lt as normalizeOutputError, N as assertRequestedModelSupported, Ot as withInterrupt, Q as formatPerfMetric, Qt as asTrimmedString, S as advertisedModelState, T as sessionOptionsFromRecord, Tt as textPrompt, U as findSessionByDirectoryWalk, V as findGitRepositoryRoot, W as isoNow, Wt as OUTPUT_ERROR_CODES, X as writeSessionRecord, Y as resolveSessionRecord, Zt as asRecord, _ as createSessionConversation, _t as isAcpJsonRpcMessage, a as applyRequestedModelIfAdvertised, at as startPerfTimer, b as recordSessionUpdate, c as setCurrentModelId, d as setDesiredModelId, dt as defaultSessionEventLog, et as incrementPerfCounter, f as syncAdvertisedModelState, ft as sessionBaseDir, g as cloneSessionConversation, gt as extractSessionUpdateNotification, h as cloneSessionAcpxState, ht as sessionEventSegmentPath, i as connectAndLoadSession, it as setPerfGauge, k as AcpClient, kt as withTimeout, l as setDesiredConfigOption, lt as normalizeRuntimeSessionId, m as applyConfigOptionsToState, mt as sessionEventLockPath, n as runPromptTurn, nn as QueueConnectionError, nt as recordPerfDuration, o as currentModelIdFromSetModelResponse, p as applyConfigOptionsToRecord, pt as sessionEventActivePath, q as normalizeName, r as withConnectedSession, rn as QueueProtocolError, rt as resetPerfMetrics, s as clearDesiredConfigOption, t as LiveSessionCheckpoint, tt as measurePerf, u as setDesiredModeId, v as recordClientOperation, vt as parseJsonRpcErrorMessage, w as persistSessionOptions, wt as promptToDisplayText, x as trimConversationForRuntime, xt as isPromptInput, y as recordPromptSubmission, yt as parsePromptStopReason } from "./live-checkpoint-j8P3Hu2K.js";
...
var JsonOutputFormatter = class {
	...
	sanitizeReadResponse(message) {
		...
		if (!hasResult && !Object.hasOwn(candidate, "error")) return message;
...
//# sourceMappingURL=output-np34hsQ4.js.map