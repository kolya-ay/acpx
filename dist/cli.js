#!/usr/bin/env node
import { a as runSessionQueueOwner, c as buildQueueOwnerArgOverride, g as __exportAll, h as isProcessAlive, l as flushPerfMetricsCapture, n as getTextErrorRemediationHints, o as runOnce, p as probeQueueOwnerHealth, t as createOutputFormatter, u as installPerfMetricsCapture } from "./output-np34hsQ4.js";
import { At as DEFAULT_AGENT_NAME, Ct as parsePromptSource, Dt as TimeoutError, Et as InterruptedError, G as listSessions, H as findSession, Ht as EXIT_CODES, Kt as OUTPUT_FORMATS, L as getAcpxVersion, Lt as normalizeOutputError, Mt as normalizeAgentName$1, Pt as exitCodeForOutputErrorCode, St as mergePromptSourceWithText, Tt as textPrompt, U as findSessionByDirectoryWalk, V as findGitRepositoryRoot, X as writeSessionRecord, Zt as asRecord$1, _t as isAcpJsonRpcMessage, bt as PromptInputValidationError, ct as serializeSessionRecordForDisk, dt as defaultSessionEventLog, en as AcpxOperationalError, ht as sessionEventSegmentPath, jt as listBuiltInAgents, lt as normalizeRuntimeSessionId, mt as sessionEventLockPath, ot as parseSessionRecord, pt as sessionEventActivePath, q as normalizeName, tn as AgentSpawnError } from "./live-checkpoint-j8P3Hu2K.js";
import { _ as resolveGlobalFlags, b as resolveSessionNameFromFlags, c as parseHistoryLimit, d as parseOutputFormat$1, f as parsePruneBeforeDate, g as resolveAgentInvocation, h as parseTtlSeconds, i as addSessionOption, l as parseMaxTurns, m as parseTimeoutSeconds, n as addPromptInputOption, o as parseAllowedTools, p as parseSessionName, r as addSessionNameOption, s as parseDaysOlderThan, t as addGlobalFlags, u as parseNonEmptyValue, v as resolveOutputPolicy, x as loadPermissionPolicySpec, y as resolvePermissionMode } from "./flags-DHEsASgE.js";
...
function loadSessionModule() {
	sessionModulePromise ??= import("./output-np34hsQ4.js").then((n) => n.i);
	return sessionModulePromise;
}
function loadOutputModule() {
	outputModulePromise ??= import("./output-np34hsQ4.js").then((n) => n.r);
...
function registerFlowCommand(program, config) {
	program.command("flow").description("Run multi-step ACP workflows from flow files").command("run").description("Run a flow file").argument("<file>", "Flow module path").option("--input-json <json>", "Flow input as JSON").option("--input-file <path>", "Read flow input JSON from file").option("--default-agent <name>", "Default agent profile for ACP nodes without profile", (value) => parseNonEmptyValue("Default agent", value)).action(async function(file, flags) {
		const { handleFlowRun } = await import("./cli-DDP7IMPi.js");
